...
SELECT
    ...
    fd.dl_state,
    fd.ins_co,
    DECODE(fd.is_alc_use_suspected, '1', 'Y', '0', 'N', NULL) AS is_alc_use_suspected,
    DECODE(fd.is_distracted, '1', 'Y', '0', 'N', NULL) AS is_distracted,
    DECODE(fd.is_drug_use_suspected, '1', 'Y', '0', 'N', NULL) AS is_drug_use_suspected,
    DECODE(fd.is_using_eye_protection, '1', 'Y', '0', 'N', NULL) AS is_using_eye_protection,
    DECODE(fd.is_re_exam_recommended, '1', 'Y', '0', 'N', NULL) AS is_re_exam_recommended,
    fd.fatality_cnt,
