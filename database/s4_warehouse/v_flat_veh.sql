...
SELECT
    ...
    veh.est_speed,
    DECODE(veh.is_comm_veh, '1', 'Y', '0', 'N', NULL) AS is_comm_veh,
    DECODE(veh.is_emerg_veh, '1', 'Y', '0', 'N', NULL) AS is_emerg_veh,
    DECODE(veh.is_hazmat_released, '1', 'Y', '0', 'N', NULL) AS is_hazmat_released,
    DECODE(veh.is_hit_and_run, '1', 'Y', '0', 'N', NULL) AS is_hit_and_run,
    DECODE(veh.is_owner_a_business, '1', 'Y', '0', 'N', NULL) AS is_owner_a_business,
    DECODE(veh.is_perm_reg, '1', 'Y', '0', 'N', NULL) AS is_perm_reg,
    DECODE(veh.is_towed_due_to_dmg, '1', 'Y', '0', 'N', NULL) AS is_towed_due_to_dmg,
