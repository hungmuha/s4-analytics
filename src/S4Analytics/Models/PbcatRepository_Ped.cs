...
namespace S4Analytics.Models
{
    public partial class PbcatRepository
    {
        ...
        public void Add(int hsmvRptNbr, string userName, PBCATPedestrianInfo pedInfo, CrashTypePedestrian crashType)
        {
        ...
        public void Update(int hsmvRptNbr, string userName, PBCATPedestrianInfo pedInfo, CrashTypePedestrian crashType)
        {
            // convert some values to int
            int crashGroupNbr;
            int crashTypeNbr;
