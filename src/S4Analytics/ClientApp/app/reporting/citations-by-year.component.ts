...
@Component({
    selector: 'citations-by-year',
    template: `<card>
        <ng-container card-header>
            <div class="font-weight-bold">Citations by year</div>
        </ng-container>
        <div class="m-3" card-block>
            <div id="citationsByYear" class="mr-3"></div>
        </div>
...
export class CitationsByYearComponent implements OnInit, OnChanges {
    ...
    ngOnChanges() {
        ...
        this.sub = this.reporting
            .getCitationsOverTimeByYear(this.query)
