...
@Component({
    selector: 'citations-by-month',
    template: `<card>
        <ng-container card-header>
            <div class="font-weight-bold">Citations by month</div>
        </ng-container>
        <div class="m-3" card-block>
            <div id="citationsByMonth" class="mr-3"></div>
        </div>
...
export class CitationsByMonthComponent implements OnInit, OnChanges {
    ...
    private retrieveData() {
        ...
        this.sub = this.reporting
            .getCitationsOverTimeByMonth(this.reportYear, this.query)
            .subscribe(report => {
