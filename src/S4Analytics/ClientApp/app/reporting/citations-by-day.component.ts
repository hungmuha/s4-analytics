...
import {CitationReportingService, CitationsOverTimeQuery, ReportOverTime, EventsByDayFormatter} from './shared';

@Component({
    selector: 'citations-by-day',
    template: `<card>
        <ng-container card-header>
            <div class="font-weight-bold">Citations by day</div>
        </ng-container>
        <div class="m-3" card-block>
            <div id="citationsByDay"></div>
        </div>
...
export class CitationsByDayComponent implements OnInit, OnChanges {
    ...
    ngOnInit() {
        ...
        this.chart = Highstock.stockChart('citationsByDay', options);
    ...
    private retrieveData() {
        ...
        this.sub = this.reporting
            .getCitationsOverTimeByDay(this.reportYear, this.alignByWeek, this.query)
            .subscribe(report => {
